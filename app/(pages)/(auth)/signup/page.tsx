// chat-app/app/(pages)/(auth)/signup/page.tsx
"use client";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (signUpError) {
        ...
        setToastMessage('Please check your email to verify your account. Redirecting to sign-in page...');
        setShowToast(true);
      }
    } catch (err) {
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        >
          ...
          <p className="mt-2 text-center text-sm text-gray-400">
            Or{' '}
            <Link href="/signin" className="font-medium text-green-400 hover:text-green-300 transition-colors">
